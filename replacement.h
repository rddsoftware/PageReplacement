...
protected:
    ...
    unsigned int num_page_replacements = 0;
    unsigned int num_page_references = 0;
    int frame_capacity;
    int num_pages;
    int num_frames;
    int frame_index;
...
public:
	 ...
	 * @return whether it's a page fault: true if it's a page fault, false otherwise.
	 */
	 ...
	 * @param page_num The logical page number.
     * @details It is a virtual function to be implemented in specific replacement subclasses.
     *          It is called by access_page function if the page is valid.
     *          It may be overridden in a subclass
     */
     ...
     * @details It is a pure virtual function to be implemented in specific replacement subclasses.
     *          It is called by access_page function if the page is not valid and no free frame is available.
     *          It is a pure virtual function to be implemented in specific replacement subclasses.
	 */
     ...
     * @param page_num The logical page number.
     * @return The ith entry of the page table
	 */
     ...
     * @details It prints the number of page faults, page replacements, and page references.
     *          It also prints the page fault rate and page replacement rate.
	 */
