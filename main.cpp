...
int main(int argc, char *argv[]) {
    ...
    std::cout << "Author: Jordan Aquino and Jamison Coombs" << std::endl;
    std::cout << "Date: 12/0x/2022" << std::endl;
    ...
    // Add your code to calculate number of page faults using LIFO replacement algorithm
    ...
    // Add your code to calculate number of page faults using LRU replacement algorithm
